...
export default function Test() {
    return (
        <main className="bg-background text-secondary">
                ...
                <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-16 xl:px-24 py-16 lg:py-20">
                    ...
                    <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            {
                                title: "Save time",
                                desc: "Skip weeks of browsing and manual scraping.",
                            },
                            {
                                title: "Save money",
                                desc: "Validate before you build. Ship only what matters.",
                            },
                            {
                                title: "Iterate faster",
                                desc: "Filter, search and cluster pains to spot patterns instantly.",
                            },
                        ].map((c) => (
                            <div
                                key={c.title}
            ...
            {/* PRICING */}
            <section className="px-6 md:px-12 lg:px-16 xl:px-24 py-20 bg-white text-center">
